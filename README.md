...
### Step - 3 Open the file
    Open project.ipynb file on Jupyter Notebook, JupyterLab, or VS Code.

### Note
The notebook uses **sample generated data for local development**. To use the actual Kaggle dataset:
1. Download the dataset from: https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud
2. Place the CSV file in the project directory
3. Replace the sample data generation code with the appropriate pandas read_csv() function
